...
{
    public class MyIdentityStore : UserStoreBase<IdentityUser, string, IdentityUserClaim<string>, IdentityUserLogin<string>, IdentityUserToken<string>>
    {

        public MyIdentityStore( IdentityErrorDescriber describer) : base(describer)
        {
